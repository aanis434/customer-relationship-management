        ...
        <Fragment>
            ...
            <nav className="navbar navbar-expand-lg main-navbar">
                ...
                <ul className="navbar-nav mr-3">
                    <li>
                    <a data-toggle="sidebar" className="nav-link nav-link-lg"><i className="fas fa-bars"></i></a>
                    </li>
                </ul>
                </form>
                <ul className="navbar-nav navbar-right">
                <li className="dropdown dropdown-list-toggle">
                    <a data-toggle="dropdown" className="nav-link nav-link-lg message-toggle beep"><i
                ...
                <li className="dropdown dropdown-list-toggle">
                    <a data-toggle="dropdown" className="nav-link notification-toggle nav-link-lg beep"><i
